...
class ConfigureWeatherRefreshUseCase @Inject constructor(
    private val settingsRepository: SettingsRepository,
    private val scheduler: WeatherRefreshScheduler,
) {

    suspend operator fun invoke(): DomainResult<WeatherRefreshInterval> {
        return when (val result = settingsRepository.getWeatherRefreshInterval()) {
