package com.byronzhang.android.weather.data.repository;

import android.content.Context;
import android.text.TextUtils;

import com.byronzhang.android.library.util.NetworkUtils;
import com.byronzhang.android.weather.data.db.dao.WeatherDao;
import com.byronzhang.android.weather.data.db.entities.adapter.CloudWeatherAdapter;
import com.byronzhang.android.weather.data.db.entities.adapter.MiWeatherAdapter;
import com.byronzhang.android.weather.data.db.entities.minimalist.Weather;
import com.byronzhang.android.weather.data.http.ApiClient;
import com.byronzhang.android.weather.data.http.ApiConstants;
import com.byronzhang.android.weather.data.http.entity.envicloud.EnvironmentCloudCityAirLive;
import com.byronzhang.android.weather.data.http.entity.envicloud.EnvironmentCloudForecast;
import com.byronzhang.android.weather.data.http.entity.envicloud.EnvironmentCloudWeatherLive;
    ...
    public static Observable<Weather> getWeather(Context context, String cityId, WeatherDao weatherDao, boolean refreshNow) {
        ...
        switch (ApiClient.configuration.getDataSourceType()) {
            case ApiConstants.WEATHER_DATA_SOURCE_TYPE_MI:
                observableForGetWeatherFromNetWork = ApiClient.miWeatherService.getMiWeather(cityId)
